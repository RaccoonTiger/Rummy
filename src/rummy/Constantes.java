...
public class Constantes {
	...
	public static final char NOIR  = 'N'; //utilis�e pour repr�senter un joker
	
	//Les 13 num�ros des pi�ces :
	public static final int[] NUMEROS = {UN,DEUX,TROIS,QUATRE,CINQ,SIX,SEPT,
			HUIT,NEUF,DIX,ONZE,DOUZE,TREIZE};
	
	//Les 4 couleurs des pi�ces :
